    ...
    export default {
      ...
      methods: {
        ...
        calRatio : function (num1,num2,pos){
            var p_num1 = parseInt(num1);
            var p_num2 = parseInt(num2);
      ...
      computed: {
          ...
          buying_in_cost : function (){
            return  parseInt(this.apprDocInfo.travel_cost) +
                    parseInt(this.apprDocInfo.insurance_cost) +
                    parseInt(this.apprDocInfo.other_cost);
          },

          buying_in_cost_last : function (){
            return  parseInt(this.apprDocInfoLast.travel_cost) +
                    parseInt(this.apprDocInfoLast.insurance_cost) +
                    parseInt(this.apprDocInfoLast.other_cost);
          },

          gross_profit_amt : function (){
              return  parseInt(this.apprDocInfo.sell_price) -
                      parseInt(this.apprDocInfo.cost_price) -
                      parseInt(this.buying_in_cost);
            },

          sell_price_first_mon : function () {
                var p_work_rate =  this.$_.floor(parseInt(this.apprDocInfo.work_days) /
                        parseInt(this.apprDocInfo.business_days),2);
                return this.$_.round(parseInt(this.apprDocInfo.sell_price) * p_work_rate ,0 )
          },

          cost_price_first_mon : function () {
              var p_work_rate =  this.$_.floor(parseInt(this.apprDocInfo.work_days) /
                      parseInt(this.apprDocInfo.business_days),2);
              return this.$_.round(parseInt(this.apprDocInfo.cost_price) * p_work_rate ,0 )
          },

          buying_in_cost_first_mon : function (){
            return  parseInt(this.apprDocInfo.travel_cost_first_mon) +
                  parseInt(this.apprDocInfo.other_cost_first_mon);
          },

          gross_profit_amt_first_mon : function (){
            return  parseInt(this.sell_price_first_mon) -
                    parseInt(this.cost_price_first_mon) -
                    parseInt(this.buying_in_cost_first_mon);
          },

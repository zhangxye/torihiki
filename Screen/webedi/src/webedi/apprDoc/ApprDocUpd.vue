<template>
      <div id="appr_doc_info">
        ...
        class="apprDoc-ruleForm">
         ...
         <el-row>
          <el-col :span="4"><h3>【稟議書】</h3></el-col>
          ...
          照会へ
           ...
           label-width="180px"
           label="法人・個人基本情報変更"
           prop="emp_info_chg_flg">
          <el-tooltip
            placement="bottom-end"
            effect="light">
              <div slot="content">
               <b>作業期間のみ変更の場合は「変更なし」にしてください。</b>
               </div>
               <i class="el-icon-information"></i>
           </el-tooltip>
           <el-switch
             v-model="apprDocInfo.emp_info_chg_flg"
             on-value="Y"
             off-value="N"
             on-text="あり"
             off-text="なし"
            ...
            <el-form-item label="営業副担当" prop="business_sub_user_id">
              <el-select
              clearable
              size="small"
              style="width:120px"
            ...
            label="生年月日">
              ...
              style="width:120px"
              placeholder="生年月日"
              v-model="apprDocInfo.emp_birthday"
              :disabled="true">
              </el-date-picker>
            </el-form-item>
            <el-form-item label="フリガナ" prop="emp_nm_fuli">
               ...
               size="small"
                type="text"
                style="width:180px"
                v-model="apprDocInfo.emp_nm_fuli"
                :disabled="true"
                auto-complete="on">
              </el-input>
            </el-form-item >
            ...
            <el-form-item
             ...
             label="性別"
              ...
              size="small"
              style="width:70px"
              v-model="apprDocInfo.emp_sex"
              :disabled="true"
              placeholder="性別" >
                  <el-option
                  v-for="item in emp_sex_list"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value">
                  </el-option>
            ...
            label="入社日">
              ...
              style="width:120px"
              placeholder="入社日"
              v-model="apprDocInfo.entrance_dt">
              </el-date-picker>
            </el-form-item>
             ...
             <el-form-item label="退社日">
              ...
              style="width:120px"
              placeholder="退社日"
              v-model="apprDocInfo.withdrawal_dt">
              </el-date-picker>
            </el-form-item>
           ...
           <el-form-item label="最寄駅（自宅）" prop="from_home_station_nm">
              ...
              size="small"
              style="width:200px"
              v-model="apprDocInfo.from_home_station_nm"
              :disabled="true"
              placeholder="最寄駅（自宅）" >
              </el-input>
            </el-form-item >
            ...
            <el-form-item label="入社経歴" prop="entrance_record_k">
              <el-popover
              :disabled="this.apprDocInfo.entrance_record_k === '1'?false:true"
              ref="entrance_record"
              placement="right"
              :width="800"
              trigger="click">
                <el-table
                stripe
                :data="entrance_record_list">
                  <el-table-column
                   :width="120"
                   property="entrance_dt_dlt"
                   label="入場日">
                  </el-table-column>
                  <el-table-column
                   :width="150"
                   property="appr_doc_dt_from"
                   label="注文期間(From)">
                  </el-table-column>
                  <el-table-column
                   :width="150"
                   property="appr_doc_dt_to"
                   label="注文期間(To)">
                  </el-table-column>
                  <el-table-column
                  :width="300"
                  ...
                  <el-table-column
                  :width="300"
                  property="work_content"
                  label="作業内容">
                  </el-table-column>
                </el-table>
              </el-popover>
              <el-button
              v-popover:entrance_record>
             ...
             <el-form-item label="マイナンバー" prop="emp_my_number">
                ...
                size="small"
                style="width:200px"
                v-model="apprDocInfo.emp_my_number"
                :disabled="true"
                placeholder="マイナンバー" >
                </el-input>
              </el-form-item >
              ...
              <el-form-item label="保険加入" prop="insurance_k">
                ...
                size="small"
                style="width:120px"
                v-model="apprDocInfo.insurance_k"
                :disabled="!insurance_k_valid_f"
                placeholder="" >
                    <el-option
                    v-for="item in insurance_k_list"
                    :key="item.value"
                    :label="item.label"
                    :value="item.value">
                    </el-option>
                ...
                <el-form-item
                 label="社保加入予定日"
                 prop="insurance_join_ymd">
                 <el-date-picker
                 size="small"
                 type="date"
                 style="width:120px"
                 placeholder="YYYY-MM-DD"
                 :disabled="!insurance_join_ymd_valid_f"
                 v-model="apprDocInfo.insurance_join_ymd">
                 </el-date-picker>
                 <span><b>から</b></span>
               </el-form-item>
     ...
     <h3>【売上／粗利／明細】</h3>
      <el-row :gutter="10">
       <el-col :span="10">
             <el-form-item
              ...
              size="small"
              style="width:120px"
              v-model.number="apprDocInfo.business_days"
              :min="1"
              :max="31">
              </el-input-number>
             </el-form-item>
             <el-form-item
              ...
              size="small"
              style="width:120px"
              v-model.number="apprDocInfo.work_days"
              :min="1"
              :max="31">
              </el-input-number>
             </el-form-item>
              ...
              label="工数人月（日割）"
              label-width="150px"
              prop="work_business_ratio">
              <el-input
                 size="small"
                 type="text"
                 style="width:80px"
                 :disabled="true"
                 v-model="work_business_ratio">
               </el-input>
             </el-form-item>
              ...
              <el-form-item
               label="売上販売計上月"
               label-width="150px"
               prop="sales_addup_month">
                 <el-date-picker
                 size="small"
                 type="month"
                 style="width:120px"
                 placeholder="YYYY-MM"
                 v-model="apprDocInfo.sales_addup_month">
                 </el-date-picker>
              </el-form-item>
              <el-form-item
               required
               ...
               prop="billing_month">
                 ...
                 style="width:120px"
                 placeholder="YYYY-MM"
                 v-model="apprDocInfo.billing_month">
                 </el-date-picker>
              </el-form-item>
           ...
           <el-form-item
              ...
              <el-input
                size="small"
                 ...
                 :minlength="2"
                 :maxlength="10"
                 v-model="apprDocInfo.other_cost">
               </el-input>
           ...
           <el-form-item
              ...
              <el-input
                size="small"
                 ...
                 :minlength="2"
                 :maxlength="10"
                 v-model="apprDocInfo.other_cost_first_mon">
               </el-input>
        ...
        <span class="money">
          {{formatMoney(basic_salary,0,"￥")}}
           ...
           <el-form-item
            ...
            :maxlength="9"
            :min="0"
            v-model.number="apprDocInfo.site_allow_amt">
         <template slot="prepend">￥</template>
        </el-input>
         {{apprDocInfo.site_allow_ratio}}%
        </el-form-item>
        <el-form-item label="残業手当"
         prop="overwork_allow_amt">
          <el-input
            size="small"
            type="text"
            style="width:100px"
            :maxlength="9"
            :min="0"
            v-model.number="apprDocInfo.overwork_allow_amt">
          <template slot="prepend">￥</template>
          </el-input>
          {{apprDocInfo.overwork_allow_ratio}}%
           </el-form-item>
        </el-col>
        <el-col :span="8">
        <el-form-item label="役職手当"
         prop="appoint_allow_amt">
          <el-input
            size="small"
            type="text"
            style="width:100px"
            :maxlength="9"
            :min="0"
            v-model.number="apprDocInfo.appoint_allow_amt">
            <template slot="prepend">￥</template>
          </el-input>
          {{apprDocInfo.appoint_allow_ratio}}%
        </el-form-item>
        <el-form-item
         label="通信手当"
         prop="communication_allow_amt">
           <el-input
            size="small"
            type="text"
            style="width:100px"
            :maxlength="9"
            :min="0"
            v-model.number="apprDocInfo.communication_allow_amt">
            <template slot="prepend">￥</template>
          </el-input>
          {{apprDocInfo.communication_allow_ratio}}%
        </el-form-item>
        <el-form-item
        label="住宅手当"
         prop="house_allow_amt">
           <el-input
            size="small"
            type="text"
            style="width:100px"
            :maxlength="9"
            :min="0"
            v-model.number="apprDocInfo.house_allow_amt">
            <template slot="prepend">￥</template>
          </el-input>
           {{apprDocInfo.house_allow_ratio}}%
        </el-form-item>
        </el-col>

        <el-col :span="8">
        <el-form-item
         prop="other_allow1_nm">
         <el-input
            size="small"
            type="text"
            style="width:120px"
            v-model="apprDocInfo.other_allow1_nm">
            <template slot="append">手当</template>
          </el-input>
        </el-form-item>
        <el-form-item
            prop="other_allow1_amt">
           <el-input
            size="small"
            type="text"
            style="width:100px"
            :maxlength="9"
            :min="0"
            v-model.number="apprDocInfo.other_allow1_amt">
            <template slot="prepend">￥</template>
          </el-input>
          {{apprDocInfo.other_allow1_ratio}}%
        </el-form-item>

        <el-form-item
         prop="other_allow2_nm">
         <el-input
            size="small"
            type="text"
            style="width:120px"
            v-model="apprDocInfo.other_allow2_nm">
            <template slot="append">手当</template>
          </el-input>
        </el-form-item>
       <el-form-item
         prop="other_allow2_amt">
          <el-input
            size="small"
            type="text"
            style="width:100px"
            :maxlength="9"
            :min="0"
            v-model.number="apprDocInfo.other_allow2_amt">
            <template slot="prepend">￥</template>
          </el-input>
          {{apprDocInfo.other_allow2_ratio}}%
        </el-form-item>
        </el-col>
        </el-row>
      <h3>【クライアント連絡先】</h3>
      <div class="client_erea">
            <el-form-item
            label-width="100px"
            label="クライアント"
            prop="client_nm">
            ...
            <el-form-item
             ...
             <el-input
               size="small"
                type="text"
                style="width:300px"
                v-model="apprDocInfo.client_url"
                :disabled="true">
              </el-input>
            </el-form-item>
            <h4>基本情報</h4>
            <el-form-item
             ...
             <el-input
               size="small"
                type="text"
                style="width:100px"
                v-model="apprDocInfo.client_post_no"
                :disabled="true">
              </el-input>
            </el-form-item>
           <el-form-item
             ...
             <el-input
               size="small"
                type="text"
                style="width:600px"
                v-model="apprDocInfo.client_addr"
                :disabled="true">
              </el-input>
            </el-form-item>
           ...
           <el-form-item
             ...
             <el-input
               size="small"
                type="text"
                style="width:150px"
                v-model="apprDocInfo.client_tel_no"
                :disabled="true">
              </el-input>
            </el-form-item>
           <el-form-item
             ...
             <el-input
               size="small"
                type="text"
                style="width:150px"
                v-model="apprDocInfo.client_fax_no"
                :disabled="true">
              </el-input>
            </el-form-item>
           <el-form-item
             label="法人マイナンバー"
             label-width="140px"
             prop="client_my_number">
             <el-input
               size="small"
                type="text"
                style="width:200px"
                v-model="apprDocInfo.client_my_number"
                :disabled="true">
              </el-input>
            </el-form-item>
            ...
            <el-tabs type="border-card">
              ...
              <el-form-item
                ...
                <el-input
                  size="small"
                   type="text"
                   style="width:200px"
                   v-model="apprDocInfo.client_staff_nm"
                   :disabled="true">
                   <el-button
                    slot="append"
                    @click="showClientStaffDlg(apprDocInfo.client_no,setClientStaffInfo)"
                    icon="search">
                    </el-button>
                 </el-input>
               </el-form-item>
               <el-form-item
                 ...
                 <el-input
                   size="small"
                    type="text"
                    style="width:150px"
                    v-model="apprDocInfo.client_staff_dept_nm"
                    :disabled="true">
                  </el-input>
                </el-form-item>
               <el-form-item
                 ...
                 <el-input
                   size="small"
                    type="text"
                    style="width:200px"
                    v-model="apprDocInfo.client_mail_addr"
                    :disabled="true">
                  </el-input>
                </el-form-item>
              ...
              <el-form-item
                ...
                <el-input
                  size="small"
                   type="text"
                   style="width:150px"
                   v-model="apprDocInfo.client_staff_nm_fuli"
                   :disabled="true">
                 </el-input>
               </el-form-item>
              <el-form-item
                ...
                <el-input
                  size="small"
                   type="text"
                   style="width:150px"
                   v-model="apprDocInfo.client_staff_position"
                   :disabled="true">
                 </el-input>
               </el-form-item>
              <el-form-item
                label="メールアドレス（CC）"
                label-width="170px"
                prop="client_mail_addr_cc">
                <el-input
                  size="small"
                   type="text"
                   style="width:200px"
                   v-model="apprDocInfo.client_mail_addr_cc"
                   :disabled="true">
                 </el-input>
               </el-form-item>
              ...
              <el-form-item
                ...
                <el-input
                  size="small"
                   type="text"
                   style="width:150px"
                   v-model="apprDocInfo.client_staff_tel_no"
                   :disabled="true">
                 </el-input>
               </el-form-item>
              <el-form-item
                ...
                <el-input
                  size="small"
                   type="text"
                   style="width:150px"
                   v-model="apprDocInfo.client_staff_fax_no"
                   :disabled="true">
                 </el-input>
               </el-form-item>
              <el-form-item
                ...
                <el-input
                  size="small"
                   type="text"
                   style="width:150px"
                   v-model="apprDocInfo.client_staff_mobile_no"
                   :disabled="true">
                 </el-input>
               </el-form-item>
              </el-tab-pane>
              ...
              <el-form-item
                label-width="80px"
                label="氏名"
                prop="client_req_staff_nm">
                <el-input
                  size="small"
                   type="text"
                   style="width:200px"
                   v-model="apprDocInfo.client_req_staff_nm"
                   :disabled="true">
                    <el-button
                    slot="append"
                    @click="showClientStaffDlg(apprDocInfo.client_no,setClientReqStaffInfo)"
                    icon="search">
                    </el-button>
                 </el-input>
               </el-form-item>
               <el-form-item
                 label="所属部署"
                 prop="client_req_staff_dept_nm">
                 <el-input
                   size="small"
                    type="text"
                    style="width:150px"
                    v-model="apprDocInfo.client_req_staff_dept_nm"
                    :disabled="true">
                  </el-input>
                </el-form-item>
               <el-form-item
                 label="メールアドレス"
                 prop="client_req_mail_addr">
                 <el-input
                   size="small"
                    type="text"
                    style="width:200px"
                    v-model="apprDocInfo.client_req_mail_addr"
                    :disabled="true">
                  </el-input>
                </el-form-item>
              ...
              <el-form-item
                label-width="80px"
                label="フリガナ"
                prop="client_req_staff_nm_fuli">
                <el-input
                  size="small"
                   type="text"
                   style="width:150px"
                   v-model="apprDocInfo.client_req_staff_nm_fuli"
                   :disabled="true">
                 </el-input>
               </el-form-item>
              <el-form-item
                label-width="70px"
                label="役職"
                prop="client_req_staff_position">
                <el-input
                  size="small"
                   type="text"
                   style="width:150px"
                   v-model="apprDocInfo.client_req_staff_position"
                   :disabled="true">
                 </el-input>
               </el-form-item>
              <el-form-item
                label="メールアドレス（CC）"
                label-width="170px"
                prop="client_req_mail_addr_cc">
                <el-input
                  size="small"
                   type="text"
                   style="width:200px"
                   v-model="apprDocInfo.client_req_mail_addr_cc"
                   :disabled="true">
                 </el-input>
               </el-form-item>
              ...
              <el-form-item
                label-width="140px"
                label="電話番号（直通）"
                prop="client_req_tel_no">
                <el-input
                  size="small"
                   type="text"
                   style="width:150px"
                   v-model="apprDocInfo.client_req_tel_no"
                   :disabled="true">
                 </el-input>
               </el-form-item>
              <el-form-item
                label-width="80px"
                label="FAX番号"
                prop="client_req_fax_no">
                <el-input
                  size="small"
                   type="text"
                   style="width:150px"
                   v-model="apprDocInfo.client_req_fax_no"
                   :disabled="true">
                 </el-input>
               </el-form-item>
              <el-form-item
                label-width="100px"
                label="携帯番号"
                prop="client_req_staff_mobile_no">
                <el-input
                  size="small"
                   type="text"
                   style="width:150px"
                   v-model="apprDocInfo.client_req_staff_mobile_no"
                   :disabled="true">
                 </el-input>
               </el-form-item>
              <el-form-item
               ...
               <el-input
                 size="small"
                  type="text"
                  style="width:120px"
                  v-model="apprDocInfo.client_req_post_no"
                  :disabled="true">
                </el-input>
              </el-form-item>
             <el-form-item
               label-width="60px"
               label="住所"
               prop="client_req_addr">
               <el-input
                 size="small"
                  type="text"
                  style="width:600px"
                  v-model="apprDocInfo.client_req_addr"
                  :disabled="true">
                </el-input>
              </el-form-item>
              </el-tab-pane>
      ...
      <h4>月次説明</h4>
        ...
        prop="mon_pro_k">
          ...
          size="small"
          style="width:120px"
          v-model="apprDocInfo.mon_pro_k"
          placeholder="区分" >
              <el-option
              v-for="item in mon_pro_k_list"
              :key="item.value"
              :label="item.label"
              :value="item.value">
              </el-option>
        ...
        <el-row :gutter="0">
        <el-col :span="24">
        <el-form-item label="作業報告書F"
        prop="work_rep_f">
          <el-select
          size="small"
          style="width:120px"
          v-model="apprDocInfo.work_rep_f"
          placeholder="作業報告書F" >
              <el-option
              v-for="item in work_rep_f_list"
              :key="item.value"
              :label="item.label"
              :value="item.value">
              </el-option>
        ...
        <el-form-item label="作業報告書〆"
        prop="work_rep_dl_k">
          <el-select
          size="small"
          style="width:120px"
          v-model="apprDocInfo.work_rep_dl_k"
          placeholder="作業報告書〆" >
              <el-option
              v-for="item in work_rep_dl_k_list"
              :key="item.value"
              :label="item.label"
              :value="item.value">
              </el-option>
        ...
        <el-row :gutter="0">
        <el-col :span="24">
        <el-form-item label="請求書F"
        prop="bill_f">
          <el-select
          size="small"
          style="width:120px"
          v-model="apprDocInfo.bill_f"
          placeholder="請求書F" >
              <el-option
              v-for="item in bill_f_list"
              :key="item.value"
              :label="item.label"
              :value="item.value">
              </el-option>
        ...
        <el-form-item label="請求書〆"
        prop="bill_dl_k">
          <el-select
          size="small"
          style="width:120px"
          v-model="apprDocInfo.bill_dl_k"
          placeholder="請求書〆" >
              <el-option
              v-for="item in bill_dl_k_list"
              :key="item.value"
              :label="item.label"
              :value="item.value">
              </el-option>
        ...
        <el-form-item label="添付資料詳細"
        prop="mon_attach_file_id">
        <el-upload
          :multiple="false"
          class="upload-demo"
          ref="file"
      ...
      <el-form-item
          ...
          prop="work_place">
           ...
           style="width:200px"
            :disabled="true"
           v-model="apprDocInfo.work_place">
         </el-input>
        </el-form-item >
      <el-form-item
         label="作業内容・範囲"
          prop="work_content">
           ...
           style="width:260px"
            :disabled="false"
           v-model="apprDocInfo.work_content">
         </el-input>
        </el-form-item >
        <el-form-item
        label="区分"
        ...
        prop="salary_pay_k">
          ...
          size="small"
          style="width:120px"
          v-model="apprDocInfo.salary_pay_k"
          placeholder="区分" >
              <el-option
              v-for="item in salary_pay_k_list"
              :key="item.value"
              :label="item.label"
              :value="item.value">
              </el-option>
             ...
             <el-form-item
                label="超過単価"
                 prop="excess_price">
                  ...
                  style="width:120px"
                  :disabled="false"
                  v-model="apprDocInfo.excess_price">
                </el-input>
            <el-tooltip
            placement="bottom-end"
            effect="light">
             ...
             <el-form-item
                label="控除単価"
                 prop="deducation_price">
                  ...
                  style="width:120px"
                  :disabled="false"
                  v-model="apprDocInfo.deducation_price">
                </el-input>
            <el-tooltip
            placement="bottom-end"
            effect="light">
        ...
        <el-select
          ...
          <el-form-item
            label="受注期間">
                <el-form-item prop="pj_start_dt">
                  ...
                  placeholder="日付"
                  :disabled="true"
                  v-model="apprDocInfo.pj_start_dt">
                  </el-date-picker>
                </el-form-item>
                ～
                <el-form-item prop="pj_end_dt">
                  <el-date-picker
                   size="small"
                   type="date"
                   style="width:120px"
             ...
             <el-form-item
                label="案件分類"
                 prop="pj_class_nm">
                  ...
                  style="width:400px"
                  :disabled="true"
                  v-model="apprDocInfo.pj_class_nm">
                </el-input>
               </el-form-item >
          ...
          <el-form-item
           ...
           <el-time-select
              placeholder="始業"
              style="width:120px"
              v-model="apprDocInfo.work_start_time"
              :picker-options="{
                start: '00:00',
                step: '00:05',
                end: '23:55',
           ...
           <el-form-item
            ...
            <el-time-select
              placeholder="終業"
              style="width:120px"
              v-model="apprDocInfo.work_end_time"
              :picker-options="{
                start: '00:00',
                step: '00:05',
                end: '23:55',
            ...
            <el-form-item
             ...
             <el-form-item label="支払サイト" :show-message="false" required></el-form-item>
            <el-form-item
              prop="payment_plan_d">
            <el-autocomplete
              size="small"
          ...
          <h3>【SES契約技術者情報】</h3>
           ...
           <el-form-item
            ...
            <el-input
               size="small"
                type="text"
                style="width:100px"
                v-model="apprDocInfo.bp_comp_id"
                placeholder="完全一致"
                @blur="setBpInfo"
                auto-complete="on">
              </el-input>
           ...
           prop="bp_comp_emp_nm">
               ...
               size="small"
                ...
                style="width:200px"
                :disabled="true"
                v-model="apprDocInfo.bp_comp_emp_nm">
              </el-input>
           </el-form-item>
           ...
           <el-form-item
            ...
            <el-input
              size="small"
               type="text"
               style="width:300px"
               v-model="apprDocInfo.bp_comp_url">
             </el-input>
           </el-form-item>
           ...
           <el-form-item
            ...
            <el-input
              size="small"
               type="text"
               style="width:120px"
               v-model="apprDocInfo.bp_post_no"
               :disabled="true">
             </el-input>
           </el-form-item>
          <el-form-item
          ...
          <el-form-item
            ...
            <el-input
              size="small"
               type="text"
               style="width:200px"
               v-model="apprDocInfo.bp_my_number"
               :disabled="true">
             </el-input>
           </el-form-item>
             ...
             <el-form-item
               ...
               <el-input
                 size="small"
                  type="text"
                  style="width:200px"
                  v-model="apprDocInfo.bp_staff_nm"
                  :disabled="true">
                     <el-button
                    slot="append"
                    @click="showClientStaffDlg(apprDocInfo.bp_comp_id,setBpStaffInfo)"
                    icon="search">
                    </el-button>
                </el-input>
              </el-form-item>
              <el-form-item
                label-width="80px"
                label="所属部署"
                prop="bp_staff_dept_nm">
                <el-input
                  size="small"
                   type="text"
                   style="width:150px"
                   v-model="apprDocInfo.bp_staff_dept_nm"
                   :disabled="true">
                 </el-input>
               </el-form-item>
              <el-form-item
                label="メールアドレス"
                prop="bp_staff_mail_addr">
                <el-input
                  size="small"
                   type="text"
                   style="width:200px"
                   v-model="apprDocInfo.bp_staff_mail_addr"
                   :disabled="true">
                 </el-input>
               </el-form-item>
             ...
             <el-form-item
               label-width="100px"
               label="フリガナ"
               prop="bp_staff_nm_fuli">
               <el-input
                 size="small"
                  type="text"
                  style="width:150px"
                  v-model="apprDocInfo.bp_staff_nm_fuli"
                  :disabled="true">
                </el-input>
              </el-form-item>
             <el-form-item
               label-width="80px"
               label="役職"
               prop="bp_staff_position">
               <el-input
                 size="small"
                  type="text"
                  style="width:150px"
                  v-model="apprDocInfo.bp_staff_position"
                  :disabled="true">
                </el-input>
              </el-form-item>
             <el-form-item
               label="メールアドレス（CC）"
               label-width="170px"
               prop="bp_staff_mail_addr_cc">
               <el-input
                 size="small"
                  type="text"
                  style="width:200px"
                  v-model="apprDocInfo.bp_staff_mail_addr_cc"
                  :disabled="true">
                </el-input>
              </el-form-item>
             ...
             <el-form-item
               label="電話番号（直通）"
               label-width="130px"
               prop="bp_staff_tel_no">
               <el-input
                 size="small"
                  type="text"
                  style="width:150px"
                  v-model="apprDocInfo.bp_staff_tel_no"
                  :disabled="true">
                </el-input>
              </el-form-item>
             <el-form-item
               label-width="80px"
               label="FAX番号"
               prop="bp_staff_fax_no">
               <el-input
                 size="small"
                  type="text"
                  style="width:150px"
                  v-model="apprDocInfo.bp_staff_fax_no"
                  :disabled="true">
                </el-input>
              </el-form-item>
             <el-form-item
               label-width="80px"
               label="携帯番号"
               prop="bp_staff_mobile_no">
               <el-input
                 size="small"
                  type="text"
                  style="width:150px"
                  v-model="apprDocInfo.bp_staff_mobile_no"
                  :disabled="true">
                </el-input>
              </el-form-item>
             ...
             <el-form-item
              ...
              <el-input
                size="small"
                 type="text"
                 style="width:120px"
                 v-model="apprDocInfo.staff_post_no"
                 :disabled="true">
               </el-input>
             </el-form-item>
            <el-form-item
              ...
              <el-input
                size="small"
                 type="text"
                 style="width:600px"
                 v-model="apprDocInfo.staff_addr"
                 :disabled="true">
               </el-input>
             </el-form-item>
             <el-form-item
              label-width="100px"
               ...
               <el-input
                 size="small"
                  type="text"
                  style="width:150px"
                  v-model="apprDocInfo.staff_tel_no"
                  :disabled="true">
                </el-input>
              </el-form-item>
             ...
             <el-form-item
              label-width="80px"
               label="携帯番号"
               prop="staff_mobile_no">
               <el-input
                 size="small"
                  type="text"
                  style="width:150px"
                  v-model="apprDocInfo.staff_mobile_no"
                  :disabled="true">
                </el-input>
              </el-form-item>
              <el-form-item
                label-width="120px"
                label="E-mail（自宅）"
                prop="staff_mail_addr">
                <el-input
                  size="small"
                   type="text"
                   style="width:200px"
                   v-model="apprDocInfo.staff_mail_addr"
                   :disabled="true">
                 </el-input>
               </el-form-item>
      ...
      <el-form-item
        ...
        label="区分"
        label-width="80px"
        prop="bp_salary_pay_k">
          <el-select
          size="small"
          style="width:120px"
          v-model="apprDocInfo.bp_salary_pay_k"
          placeholder="区分" >
              <el-option
              v-for="item in salary_pay_k_list"
              :key="item.value"
              ...
              label-width="100px"
                label="超過単価"
                 prop="bp_excess_price">
                  ...
                  style="width:120px"
                  :disabled="false"
                  v-model="apprDocInfo.bp_excess_price">
                </el-input>
               </el-form-item >
             <el-form-item
              label-width="100px"
                label="控除単価"
                 prop="bp_deducation_price">
                  ...
                  style="width:120px"
                  :disabled="false"
                  v-model="apprDocInfo.bp_deducation_price">
                </el-input>
               </el-form-item >
        ...
        <el-select
          ...
          <el-form-item
            ...
            label="就業時間">
            <el-form-item
            prop="bp_work_start_time">
            <el-time-select
              placeholder="始業"
              style="width:120px"
              v-model="apprDocInfo.bp_work_start_time"
              :picker-options="{
                start: '00:00',
                step: '00:05',
                end: '23:55',
            ...
            -
            <el-form-item
            prop="bp_work_end_time">
            <el-time-select
              placeholder="終業"
              style="width:120px"
              v-model="apprDocInfo.bp_work_end_time"
              :picker-options="{
                start: '00:00',
                step: '00:05',
                end: '23:55',
        ...
        id="salesTable">
            ...
            <tbody>
                <tr v-for="(item, index) in apprDocInfo.commute_route_list"
                  :key="'item'+index">
                  <td>
                    <el-form-item
                   :prop="'commute_route_list.'+ index +'.from_home_line_nm'"
                   :rules="[
                   ...
                   >
                    <el-input
                      size="small"
                      style="width:150px"
                      v-model="item.from_home_line_nm"
                      >
                    </el-input>
                    </el-form-item>
                  </td>
                  ...
                  <td>
                  <el-form-item
                  :prop="'commute_route_list.'+ index +'.from_home_station_nm'"
                  :rules="[
                           { required: true, message: '入力必須です', trigger: 'blur' },
                            ]"
                   >
                      ...
                      size="small"
                      style="width:150px"
                      v-model="item.from_home_station_nm">
                    </el-input>
                  </el-form-item>
                  </td>
                  <td>駅～</td>
                 <td>
                 <el-form-item
                  :prop="'commute_route_list.'+ index +'.to_comp_line_nm'"
                  :rules="[
                           { required: true, message: '入力必須です', trigger: 'blur' },
                            ]"
                   >
                 ...
                 <td>
                  <el-form-item
                  :prop="'commute_route_list.'+ index +'.to_comp_station_nm'"
                  :rules="[
                           { required: true, message: '入力必須です', trigger: 'blur' },
                           ]"
                   >
                    <el-input
                      size="small"
                      style="width:150px"
                      v-model="item.to_comp_station_nm">
                    </el-input>
                  </el-form-item>
                  </td>
                  <td>駅</td>
                 <td>
                  <el-form-item
                  :prop="'commute_route_list.'+ index +'.travel_cost'"
                  :rules="[
                           { required: true, message: '入力必須です'},
                   ...
                   >
                    <el-input
                      size="small"
                      style="width:150px"
                      @oninput.native="numberOnly(item)"
                      v-model.number="item.travel_cost">
                    </el-input>
                  </el-form-item>
                  </td>
                </tr>
                ...
                <td colspan="8" align="right">
                   <b>経路追加</b>
                       <el-button
                       size="mini"
                       @click="addCommuteRoute">
                       ＋
                       </el-button>
                       <b>経路削除</b>
                      <el-button
                      size="mini"
                     @click="delCommuteRoute">
                     －
                     </el-button>
                  <font color=red>
                  <b>
                  ...
                  <td>
                     <span class="money">{{formatMoney(travel_cost_sum,0,"￥")}}</span>
                  </td>
                </tr>
              </tbody>
              </table>
          <el-form-item
                label="日額（往復）￥"
                 prop="deducation_price">
                  ...
                  style="width:120px"
                  :disabled="true"
                  v-model="apprDocInfo.day_travel_cost">
                </el-input>
               </el-form-item >
          <el-form-item
                label-width="180px"
                label="１ヶ月の通勤代（定期）￥"
                 prop="travel_cost">
                  ...
                  style="width:120px"
                  :disabled="false"
                  v-model="apprDocInfo.travel_cost">
                </el-input>
          </el-form-item >
          <el-form-item
                label="支払上限￥"
                 prop="pay_travel_costa_max">
                  <el-input
                  size="small"
                  type="text"
                  style="width:120px"
                  v-model="apprDocInfo.pay_travel_costa_max">
                </el-input>
          </el-form-item >
          <el-form-item
                required
                label="交通費(初月)"
                 prop="travel_cost_first_mon">
                  <el-input
                  size="small"
                  type="text"
                  style="width:120px"
                  v-model="apprDocInfo.travel_cost_first_mon">
                </el-input>
          </el-form-item >
            ...
            <el-form-item
              ...
              <el-input
                ...
                style="width:750px"
                placeholder="交通経路"
                v-model="apprDocInfo.rount_dlt_content">
              </el-input>
            </el-form-item >
            ...
            <el-form-item
             ...
             label="購買手続き区分"
              prop="procedure_k">
              <el-radio-group v-model="apprDocInfo.procedure_k">
               <el-radio
                v-for="item in procedure_k_list"
                :key="item.value"
                :label="item.value">
                {{item.label}}
                </el-radio>
            ...
            label="手続予定日">
              ...
              style="width:120px"
              placeholder=""
              v-model="apprDocInfo.procedure_dt">
              </el-date-picker>
            </el-form-item>
            </el-col>
          ...
          <el-form-item label="手続方法"
          prop="procedure_method_k">
          <el-select
            clearable
            size="small"
            style="width:150px"
            v-model="apprDocInfo.procedure_method_k"
            placeholder="" >
                <el-option
                v-for="item in procedure_method_k_list"
                :key="item.value"
                :label="item.label"
                :value="item.value">
                </el-option>
          ...
          prop="withdrawal_reason_k">
          <el-select
            clearable
            size="small"
            style="width:150px"
            v-model="apprDocInfo.withdrawal_reason_k"
            @change="chgWithdrawalReasonK"
            placeholder="" >
                <el-option
                v-for="item in withdrawal_reason_k_list"
                :key="item.value"
                :label="item.label"
                :value="item.value">
                </el-option>
           ...
           <el-form-item label="離職票の有無"
           prop="withdrawal_letter_k">
           <el-switch
             v-model="apprDocInfo.withdrawal_letter_k"
             on-value="1"
             off-value="2"
             on-text="必要"
             off-text="不要"
          ...
          <el-col :span="24">
          <el-form-item label="必要書類"
          prop="withdrawal_req_doc">
          <el-select
            clearable
            size="small"
            style="width:150px"
            v-model="apprDocInfo.withdrawal_req_doc"
            :disabled="true"
            placeholder="" >
                <el-option
                v-for="item in withdrawal_req_doc_list"
                :key="item.value"
                :label="item.label"
                :value="item.value">
                </el-option>
           ...
           <el-form-item label="社保任意継続"
           prop="insurance_con_k">
           <el-switch
             v-model="apprDocInfo.insurance_con_k"
             on-value="1"
             off-value="2"
             on-text="必要"
             off-text="不要"
            ...
            <el-form-item label="依頼一覧へ登録"
             prop="dina_reg_f">
              <el-switch
               :width="58"
               on-text="する"
               off-text="しない"
               v-model="apprDocInfo.dina_reg_f"
               on-color="#13ce66"
               off-color="#ff4949">
             </el-switch>
            </el-form-item>
          ...
          <el-form-item
           label-width="150px"
            label="退職後の郵便番号〒"
            prop="after_withdrawal_post_no">
            <el-input
              style="width:120px"
              placeholder=""
              v-model="apprDocInfo.after_withdrawal_post_no">
            </el-input>
          </el-form-item >
           <el-form-item
           label-width="120px"
            label="退職後の住所"
            prop="after_withdrawal_addr">
            <el-input
              type="textarea"
              style="width:500px"
              placeholder=""
              v-model="apprDocInfo.after_withdrawal_addr">
            </el-input>
          </el-form-item >
          ...
          <h4>コメント事項</h4>
           ...
           label-width="140px"
            ...
            <el-input
              ...
              style="width:800px"
              placeholder=""
              v-model="apprDocInfo.purchase_remark">
            </el-input>
          </el-form-item >
           ...
           <el-form-item
            ...
            <el-input
              ...
              style="width:800px"
              placeholder=""
              v-model="apprDocInfo.emp_remark">
            </el-input>
          </el-form-item >
...
import { ClientStaffPopUp } from '@/webedi/apprDoc/components';
  ...
  export default {
     ...
     var chkBasicSalary = (rule, value, callback) => {
      ...
      return {
        ...
        apprDocInfo: {
          ...
          bp_work_start_time : '',  //出勤時刻（BP）
          bp_work_end_time : '',  //退勤時刻（BP）
          ...
          emp_remark : '',  //特記事項（要員）
          emp_info_chg_flg : '', //個人情報変更Flg:Y：変更あり、N：変更なし
          procedure_k : '',  // 手続き区分:1:新規入社処理 2:契約期間更新処理 3:退社処理
    ...
    methods: {
      uploadSuccess(response, file, fileList) {
        ...
        save(){
         var _this = this;
          _this.$refs.apprDocInfo.validate((valid) => {
          if (valid){
            _this.$confirm('稟議書データを更新してもよろしいでしょうか？', '注意', {
                confirmButtonText: '確定',
                cancelButtonText: '中止',
                type: 'warning'
              }).then(() => {
                    console.log(JSON.stringify(_this.apprDocInfo));
                    _this.$http.post('/api/apprDoc/update',_this.apprDocInfo)
            ...
            .then(function (response) {
              var errorcode=response.data.errorcode;
                 if(errorcode=="200"){
                    ...
                    _this.fetchInsuranceInfo(_this.$moment(_this.apprDocInfo.appr_doc_create_dt).format('YYYY-MM-DD'));
                }else if(errorcode=="500"){
                   _this.$message.error(response.data.errormsg);
                }
              })
    ...
    //         // console.log("[computed]deducation_price this.apprDocInfo.deducation_price = %s",this.apprDocInfo.deducation_price);
    //     }
    // },
    ...
    bp_wh_max_valid_f : function(){
     ...
     bp_wh_mid_valid_f : function(){
      ...
      // travel_cost :{
      //     get : function() {
      //         if(this.screen_loading ===true) return this.apprDocInfo.travel_cost;
      ...
      //         var p_travel_cost = _.toInteger(this.apprDocInfo.work_days) * _.toInteger(this.apprDocInfo.day_travel_cost);

<template>
        ...
        id="empTable">
            ...
            <tbody>
                ...
                <tr >
                    <th rowspan="4">仕入詳細</th>
                    <th colspan="2">交通費</th>
                    <td>
                        <span v-if="!apprDocInfoLast.sell_price">-</span>
                        <span v-else>{{formatMoney(apprDocInfoLast.travel_cost,0,"￥")}}</span>
                    </td>
                    <td>{{formatMoney(apprDocInfo.travel_cost,0,"￥")}}</td>
                    <td>
                      <span v-if="!apprDocInfoLast.sell_price">-</span>
                      <span v-else-if="apprDocInfoLast.travel_cost>apprDocInfo.travel_cost"
                       class="minus">
                      {{formatMoney(apprDocInfo.travel_cost - apprDocInfoLast.travel_cost,0,"￥")}}
                    </span>
                      <span v-else>
                      {{formatMoney(apprDocInfo.travel_cost - apprDocInfoLast.travel_cost,0,"￥")}}
                    </span>
                    ...
                    <td>
                        <span v-if="!apprDocInfoLast.travel_cost">-</span>
                        <span v-else-if="apprDocInfoLast.travel_cost<apprDocInfo.travel_cost">↑</span>
                        <span class="minus" v-else-if="apprDocInfoLast.travel_cost>apprDocInfo.travel_cost">↓</span>
                        <span v-else-if="apprDocInfoLast.travel_cost===apprDocInfo.travel_cost">→</span>
                    </td>
                </tr>
                <tr >
                    ...
                    <td>
                        <span v-if="!apprDocInfoLast.sell_price">-</span>
                        <span v-else>{{formatMoney(apprDocInfoLast.insurance_cost,0,"￥")}}</span>
                    </td>
                    <td>{{formatMoney(apprDocInfo.insurance_cost,0,"￥")}}</td>
                    <td>
                        <span v-if="!apprDocInfoLast.sell_price">-</span>
                        <span v-else-if="apprDocInfo.insurance_cost<apprDocInfoLast.insurance_cost"
                         class="minus">
                        {{formatMoney(apprDocInfo.insurance_cost - apprDocInfoLast.insurance_cost,0,"￥")}}
                      </span>
                        <span v-else>
                        {{formatMoney(apprDocInfo.insurance_cost - apprDocInfoLast.insurance_cost,0,"￥")}}
                      </span>
                    ...
                    <td>
                        <span v-if="!apprDocInfoLast.insurance_cost">-</span>
                        <span v-else-if="apprDocInfoLast.insurance_cost<apprDocInfo.insurance_cost">↑</span>
                        <span class="minus" v-else-if="apprDocInfoLast.insurance_cost>apprDocInfo.insurance_cost">↓</span>
                        <span v-else-if="apprDocInfoLast.insurance_cost===apprDocInfo.insurance_cost">→</span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <span v-if="!apprDocInfoLast.sell_price">-</span>
                        <span v-else>{{formatMoney(apprDocInfoLast.other_cost,0,"￥")}}</span>
                    </td>
                    <td>{{formatMoney(apprDocInfo.other_cost,0,"￥")}}</td>
                    <td >
                        <span v-if="!apprDocInfoLast.sell_price">-</span>
                        <span v-else-if="apprDocInfoLast.other_cost>apprDocInfo.other_cost"
                         class="minus">
                        {{formatMoney(apprDocInfo.other_cost - apprDocInfoLast.other_cost,0,"￥")}}
                      </span>
                        <span v-else>
                        {{formatMoney(apprDocInfo.other_cost - apprDocInfoLast.other_cost,0,"￥")}}
                      </span>
                    ...
                    <td>
                        <span v-if="!apprDocInfoLast.other_cost">-</span>
                        <span v-else-if="apprDocInfoLast.other_cost<apprDocInfo.other_cost">↑</span>
                        <span class="minus" v-else-if="apprDocInfoLast.other_cost>apprDocInfo.other_cost">↓</span>
                        <span v-else-if="apprDocInfoLast.other_cost===apprDocInfo.other_cost">→</span>
                    </td>
                </tr>
                <tr >
                    <th colspan="2">仕入合計</th>
                    <td>
                        <span v-if="!apprDocInfoLast.sell_price">-</span>
                        <span v-else>{{formatMoney(buying_in_cost_last,0,"￥")}}</span>
                    </td>
                    <td>{{formatMoney(buying_in_cost,0,"￥")}}</td>
                    <td>
                        <span v-if="!apprDocInfoLast.sell_price">-</span>
                        <span v-else-if="buying_in_cost_last>buying_in_cost"
                         class="minus">
                        {{formatMoney(buying_in_cost - buying_in_cost_last,0,"￥")}}
                      </span>
                        <span v-else>
                        {{formatMoney(buying_in_cost - buying_in_cost_last,0,"￥")}}
                      </span>
                    ...
                    <td>
                        <span v-if="!apprDocInfoLast.cost_price">-</span>
                        <span v-else-if="buying_in_cost_last<buying_in_cost">↑</span>
                        <span class="minus" v-else-if="buying_in_cost_last>buying_in_cost">↓</span>
                        <span v-else-if="buying_in_cost_last.cost_price===buying_in_cost">→</span>
                    </td>
                </tr>
                <tr >
                ...
                <tr>
                    <th colspan="2" rowspan="2">支払サイト</th>
                    <th>上</th>
                    <td>
                        <span v-if="!apprDocInfoLast.sell_price">-</span>
                        <span v-else>{{apprDocInfoLast.payment_plan_d}}日</span>
                    </td>
                    <td>{{apprDocInfo.payment_plan_d}}日</td>
                    <td>
                      <span v-if="!apprDocInfoLast.sell_price">-</span>
                       <span v-else-if="apprDocInfoLast.payment_plan_d>apprDocInfo.payment_plan_d"
                         class="minus">
                        {{minus(apprDocInfo.payment_plan_d , apprDocInfoLast.payment_plan_d)}}日
                      </span>
                        <span v-else>
                        {{minus(apprDocInfo.payment_plan_d , apprDocInfoLast.payment_plan_d)}}日
                      </span>
                    ...
                    <td>
                     <span v-if="!apprDocInfoLast.payment_plan_d">-</span>
                     <span v-else-if="apprDocInfoLast.payment_plan_d<apprDocInfo.payment_plan_d">↑</span>
                     <span class="minus" v-else-if="apprDocInfoLast.payment_plan_d>apprDocInfo.payment_plan_d">↓</span>
                     <span v-else-if="apprDocInfoLast.payment_plan_d==apprDocInfo.payment_plan_d">→</span>
                    </td>
                 </tr>
                <tr>
                   <th>下</th>
                    <td>
                        <span v-if="!apprDocInfoLast.sell_price">-</span>
                        <span v-else>{{apprDocInfoLast.bp_payment_plan_d}}日</span>
                    </td>
                    <td>{{apprDocInfo.bp_payment_plan_d}}日</td>
                    <td>
                       <span v-if="!apprDocInfoLast.sell_price">-</span>
                       <span v-else-if="apprDocInfoLast.bp_payment_plan_d>apprDocInfo.bp_payment_plan_d"
                         class="minus">
                        {{minus(apprDocInfo.bp_payment_plan_d , apprDocInfoLast.bp_payment_plan_d)}}日
                      </span>
                        <span v-else>
                        {{minus(apprDocInfo.bp_payment_plan_d , apprDocInfoLast.bp_payment_plan_d)}}日
                      </span>
                    ...
                    <td>
                     <span v-if="!apprDocInfoLast.bp_payment_plan_d">-</span>
                     <span v-else-if="apprDocInfoLast.bp_payment_plan_d<apprDocInfo.bp_payment_plan_d">↑</span>
                     <span class="minus" v-else-if="apprDocInfoLast.bp_payment_plan_d>apprDocInfo.bp_payment_plan_d">↓</span>
                     <span v-else-if="apprDocInfoLast.bp_payment_plan_d==apprDocInfo.bp_payment_plan_d">→</span>
                    </td>
                </tr>
            </tbody>

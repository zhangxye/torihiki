          ...
          <el-form class="WorkManager_top_form" :inline="true" :model="filters">
            <el-row>
              ...
              <el-form-item label="最寄り駅:" prop="from_home_station_nm">
                <el-input
                v-model="filters.from_home_station_nm"
              ...
              <el-form-item>
		            <el-checkbox v-model="checked1" label="アサイン可能フラグ" border></el-checkbox>
		            <el-checkbox v-model="checked2" label="要注意フラグ" border></el-checkbox>
  		        </el-form-item>
              <el-form-item>
      ...
      <div class="WorkManager_middle">
        <el-col class="WorkManager_middle" :span="24">
          <el-form class="WorkManager_middle_form">
            ...
            <el-button type="primary" @click="searchData" icon="edit">一括メール</el-button>
            <el-button type="warning" @click="resetData" icon="close">一括削除</el-button>
            <el-button-group style="float: right;" size="mini">
              <el-button icon="search"></el-button>
              <el-button icon="refresh"></el-button>
            </el-button-group>
              <el-row>
                <el-dialog title="要員追加" v-model="dialogIWVisible" >
                  <el-form :inline="true" :rules="rules1" :model="userInfo" ref="userInfo" label-width="110px" class="userInfo-ruleForm">
                    <span class="warning">(必須)</span>
                    <el-form-item label= "要員名" prop="account" >
                      <el-input :inline="true" type="text" v-model="userInfo.account" style="width:100px;" auto-complete="off" :disabled="true" placeholder="例)田中 太郎"></el-input>
                    </el-form-item>
                    <el-col :span="16">

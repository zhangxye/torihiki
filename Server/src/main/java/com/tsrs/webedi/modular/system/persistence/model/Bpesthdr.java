 ...
 * @since 2017-09-01
 */
public class Bpesthdr extends Model<Bpesthdr> {
     ...
     * BP見積ID
     */
	@TableId(value="bp_est_hid", type= IdType.AUTO)
     ...
     * BP見積依頼NO
     */
	@TableField("bp_est_request_no")
	private String bpEstRequestNo;
    /**
     * 使用FLG:Y/N
     */
	@TableField("use_flg")
	...
	public String getBpEstRequestNo() {
		return bpEstRequestNo;
	}

	public void setBpEstRequestNo(String bpEstRequestNo) {
		this.bpEstRequestNo = bpEstRequestNo;
	}

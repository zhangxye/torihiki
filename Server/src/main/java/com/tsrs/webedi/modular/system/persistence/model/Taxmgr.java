 ...
 * @since 2017-09-01
 */
public class Taxmgr extends Model<Taxmgr> {
     ...
     * 消費税管理ID
     */
	@TableId(value="tax_mgr_id", type= IdType.AUTO)
	private Integer taxMgrId;
    /**
     * 開始日
     */
	@TableField("start_dt")
	...
	public Integer getTaxMgrId() {
		return taxMgrId;
	}

	public void setTaxMgrId(Integer taxMgrId) {
		this.taxMgrId = taxMgrId;
	}

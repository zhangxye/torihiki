...
public class DaoConfig {
    ...
    public void init() {
        this.daoPathTemplate = "\\src\\main\\java\\com\\tsrs\\webedi\\modular\\" + contextConfig.getModuleName() + "\\dao\\{}Dao.java";
        this.xmlPathTemplate = "\\src\\main\\java\\com\\tsrs\\webedi\\modular\\" + contextConfig.getModuleName() + "\\dao\\mapping\\{}Dao.xml";
        this.packageName = "com.tsrs.webedi.modular." + contextConfig.getModuleName() + ".dao";
    }

...
import com.tsrs.webedi.common.constant.dictmap.factory.DictMapFactory;
...
import com.tsrs.webedi.core.util.Contrast;
...
//    private Logger log = Logger.getLogger(this.getClass());
    ...
    @Pointcut(value = "@annotation(com.tsrs.webedi.common.annotion.log.BussinessLog)")
...
//            log.error("日志记录出错!", e);
    ...
    private void handle(ProceedingJoinPoint point) throws Exception {
        ...
        //如果涉及到修正,比对变化
        String msg;
        if (bussinessName.indexOf("修正") != -1 || bussinessName.indexOf("编辑") != -1) {

package com.tsrs.webedi.core.template.config;
...
public class ServiceConfig {
    ...
    public void init() {
        ...
        imports.add("com.tsrs.webedi.modular." + contextConfig.getModuleName() + ".service.I" + contextConfig.getBizEnBigName() + "Service");
        this.serviceImplImports = imports;
        this.servicePathTemplate = "\\src\\main\\java\\com\\tsrs\\webedi\\modular\\" + contextConfig.getModuleName() + "\\service\\I{}Service.java";
        this.serviceImplPathTemplate = "\\src\\main\\java\\com\\tsrs\\webedi\\modular\\" + contextConfig.getModuleName() + "\\service\\impl\\{}ServiceImpl.java";
        this.packageName = "com.tsrs.webedi.modular." + contextConfig.getModuleName() + ".service";
    }

package com.tsrs.webedi.common.node;

import com.tsrs.webedi.common.constant.Const;
import com.tsrs.webedi.common.constant.state.IsMenu;
...
public class MenuNode implements Comparable {
    ...
    public static List<MenuNode> buildTitle(List<MenuNode> nodes) {
        ...
        //如果閉じる了接口文档,则不显示接口文档菜单
        WebEDIProperties webediProperties = SpringContextHolder.getBean(WebEDIProperties.class);
